...
public class FormApp {
    ...
    @Test
    public void lauchFormApp () throws InterruptedException, MalformedURLException {
        ...
        MobileElement checkText = (MobileElement)
                driver.findElementByXPath("//android.widget.ScrollView[@content-desc=\"Forms-screen\"]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.widget.TextView");
        Assert.assertEquals(checkText.getText(), "Form components");
